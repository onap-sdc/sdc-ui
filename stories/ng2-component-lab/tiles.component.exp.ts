...
export default experimentOn('Tiles')
    ...
    },
    {
        ...
        title: 'Tile with menu',
        description: 'click on the icon to open popup menu.',
        template: `
        <sdc-tile>
            <sdc-tile-info>
                <div class="sdc-tile-content-icon blue">
                    <div class="svg-icon-wrapper">
                        <svg class="svg-icon __vsp" viewBox="0 0 59.5 40" id="vsp_icon" (click)="menu.position = {x:$event.clientX, y:$event.clientY}; mopen=true;">
                            <title>
                                vsp_new_icon
                            </title>
                            <g id="Layer_2" data-name="Layer 2">
                        ...
                        <popup-menu-list [(open)]="mopen" (openChange)="menuStatus=$event" (positionChange)="menuPos=$event" #menu>
