...
const typos = [
	{className: 'heading-1', size: 28, text: 'Large Titles'},
	{className: 'heading-2', size: 24, text: 'Medium Titles'},
	{className: 'heading-4-semibold', size: 18, text: 'Small Titles'},
	{className: 'heading-5-semibold', size: 16, text: 'Mini Titles'},
